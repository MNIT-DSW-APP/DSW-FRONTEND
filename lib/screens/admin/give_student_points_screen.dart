...
class GiveStudentPointsScreen extends StatefulWidget{
  ...
  @override
  State<GiveStudentPointsScreen> createState() => _GiveStudentPointsScreenState();

}

class _GiveStudentPointsScreenState extends State<GiveStudentPointsScreen>{
  var dropDown1InitialValue = "Participant 1";
  var pointsTypeArray = ['Participant 1', 'Participant 2', 'Participant 3', 'Participant 4'];
  var dropDown2InitialValue = "The Mavericks";
  var clubNameArray = ['The Mavericks', 'E=MC^2', 'CS Club', 'Data Science Club'];
  @override
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(margin: const EdgeInsets.only(top: 7),child: const Text("+", style: TextStyle(color: Colors.green, fontSize: 30, fontWeight: FontWeight.bold),)),
                        Expanded(child: TextField(keyboardType: TextInputType.number, maxLength: 2, controller: TextEditingController(text: "00"),style: const TextStyle(color: Colors.green, fontSize: 30, fontWeight: FontWeight.bold),)),
                      ],
                    ),
                  ),
                  const Divider(),
                  ...
                  const Divider(thickness: 0.0001,),
                  Container(
                    width: 300,
                    child: Row(
                      ...
                      children: [
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(backgroundColor: Colors.white,
                              ...
                              fixedSize: const Size.fromWidth(100), elevation: 10),
